...
class ExpensesController extends \BaseController {
	...
	public function store()
	{
		...
		Notification::notifyUser($user->id,"Hello, Please check expense inserted for item ".Input::get('name'),"check expense","notificationshowexpense/".Input::get('name')."/".Input::get('type')."/".Input::get('amount')."/".date("Y-m-d",strtotime(Input::get('date')))."/".Input::get('credit_account')."/".Input::get('debit_account')."/".Confide::user()->id."/".$user->id."/".$key,$key);
     	}
