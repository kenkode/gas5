...
<div class="row">
  <div class="col-lg-5">
    ...
    <fieldset>
          ...
          <div class="form-group">
                        <label for="username">Select Purchase Order</label>
        ...
        <div class="form-group">
        <label for="username">Amount of Purchase Order</label> 
          <div class="input-group">
            <span class="input-group-addon">KES</span>
            <input type="text" class="form-control"  name="amountdue" id="amountdue" value= '{{asMoney(0.00)}}'> 
        </div>
      </div>
